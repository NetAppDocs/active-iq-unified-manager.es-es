...
* Paquetes redistribuibles de Microsoft Visual C++ para Visual Studio 2015 versión 14.29.30133.0
* MySQL Community Edition versión 8.4.10
* Python 3.13.3
* OpenJDK versión 17.0.15+6
* 7-zip versión 25.01 o posterior
