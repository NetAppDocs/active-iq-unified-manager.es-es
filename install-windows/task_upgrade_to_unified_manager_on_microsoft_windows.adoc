...
[role="lead"]
Puede actualizar Unified Manager 9.14 o 9.16 a 9.18 descargando y ejecutando el archivo de instalación en la plataforma Windows.
...
====
* MySQL Community Edition se actualiza automáticamente durante la actualización de Unified Manager. Si la versión instalada de MySQL en tu sistema es anterior a 8.4.10, el proceso de actualización de Unified Manager actualiza automáticamente MySQL a 8.4.10. No debes realizar una actualización independiente de una versión anterior de MySQL a 8.4.10.
