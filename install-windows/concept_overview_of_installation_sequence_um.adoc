...
image::../media/overall_um_install_flow.png[Un diagrama que muestra los flujos de trabajo de instalación, configuración inicial y ajustes administrativos de Unified Manager]
