...
* Tenga en cuenta que si agrega una máquina virtual de almacenamiento (SVM) o un clúster a los recursos de una alerta, los objetos secundarios no se agregan automáticamente. Por ejemplo, si agrega un clúster a los recursos de una alerta, la alerta no agrega automáticamente los nodos o LUN.
