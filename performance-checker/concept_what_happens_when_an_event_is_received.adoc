...
image::../media/um_perf_threshold_event_flow.gif[Un diagrama que muestra el procesamiento de eventos de umbral desde la recopilación de datos del contador hasta la notificación por correo electrónico]
