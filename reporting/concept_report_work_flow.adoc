...
image::../media/reports_view_workflow.png[Un diagrama que muestra un flujo de trabajo en forma de árbol de decisión para visualizar, personalizar, cargar y descargar informes]
