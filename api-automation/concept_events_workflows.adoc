...
image::../media/handling_event_related_issues_of_a_storage_object_flowchart.gif[Un diagrama de flujo que muestra el análisis de eventos de volumen, desde la enumeración de eventos hasta la acción correctiva y el final]
