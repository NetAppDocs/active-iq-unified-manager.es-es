...
image::../media/space_utilization.gif[Un diagrama de flujo para identificar volúmenes con el modo de ajuste automático activado que están sobreutilizados en agregados de clúster]
