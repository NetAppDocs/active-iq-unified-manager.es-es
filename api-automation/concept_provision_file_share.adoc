...
image::../media/create_fileshares.gif[Un diagrama que muestra un flujo de trabajo para el aprovisionamiento de recursos compartidos de archivos CIFS y NFS, desde la configuración de SVM hasta la creación del recurso compartido]
