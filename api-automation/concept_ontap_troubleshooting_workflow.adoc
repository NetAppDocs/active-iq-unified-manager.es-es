...
image::../media/api_gateway_ontap_workflow.gif[Un diagrama que muestra los pasos de Unified Manager y la API de ONTAP para solucionar problemas de alertas de capacidad de volúmenes]
