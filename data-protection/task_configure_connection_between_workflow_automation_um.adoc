...
[NOTE]
====
El "`WFA pack for managing Clustered Data ONTAP`" está incluido en WFA 5.1.1P6, así que no necesitas descargar este pack de la NetAppStorage Automation Store ni instalarlo por separado en tu servidor WFA como se requería antes. https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["Descarga de WFA"^]
