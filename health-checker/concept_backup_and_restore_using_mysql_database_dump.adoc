...
image::../media/database_backup.gif[Un diagrama que muestra tres archivos de directorio de copia de seguridad que apuntan a archivos completos e incrementales en el repositorio de la base de datos]
