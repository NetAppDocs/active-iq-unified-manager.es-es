...
[NOTE]
====
Unified Manager OVA en sistemas VMware vSphere ejecuta internamente Debian OS 13 (Trixie). Para obtener información sobre las versiones del hardware de la máquina virtual que pueden admitir las versiones compatibles de los servidores ESXi, consulta la documentación de VMware.
