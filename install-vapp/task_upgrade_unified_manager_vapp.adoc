...
[NOTE]
====
Si tu sistema se actualizó desde Unified Manager 9.7, no puedes actualizar directamente de la 9.14 a la 9.18 debido a los cambios en el sistema de archivos de las versiones de Debian. En su lugar, sigue esta ruta de actualización recomendada: 9.14 -> 9.16P2 -> 9.18.
