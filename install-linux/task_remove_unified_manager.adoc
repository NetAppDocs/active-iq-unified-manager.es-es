...
+
Este paso elimina todos los paquetes RPM de NetApp asociados. No elimina los módulos de software necesarios, como Java, MySQL y 7zip.

. *Opcional:* Si corresponde, elimine los módulos de software de soporte, como Java, MySQL y 7zip:
+
