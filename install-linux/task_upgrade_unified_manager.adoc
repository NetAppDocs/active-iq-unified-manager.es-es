...
* MySQL Community Edition se actualiza automáticamente durante la actualización de Unified Manager. Si la versión instalada de MySQL en su sistema es anterior a 8.4.7, el proceso de actualización de Unified Manager actualiza automáticamente MySQL a 8.4.7.
