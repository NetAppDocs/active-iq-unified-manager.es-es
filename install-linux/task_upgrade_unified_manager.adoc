...
* Debe instalar o actualizar a la versión correcta de 7-zip antes de actualizar Unified Manager. Ver link:task_configure_7zip_package.html["Configurar el paquete de software 7-zip"].
...
* MySQL Community Edition se actualiza automáticamente durante la actualización de Unified Manager. Si la versión de MySQL instalada en tu sistema es anterior a 8.4.10, el proceso de actualización de Unified Manager actualiza automáticamente MySQL a 8.4.10.
