...
Además, existe un límite en la cantidad de nodos que una sola instancia de Unified Manager puede monitorear antes de instalar una segunda instancia de Unified Manager. Para conocer los límites de nodos, las recomendaciones de CPU y memoria, consulte la https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["Guía de prácticas recomendadas de Unified Manager"^].
