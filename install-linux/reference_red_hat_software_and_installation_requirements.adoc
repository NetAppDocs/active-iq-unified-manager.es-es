...
Unified Manager se ha implementado en un servidor web WildFly. WildFly 27.0.1.Final se incluye y se configura junto con Unified Manager.
...
* MySQL Community Edition versión 8.4.10 (del repositorio de MySQL)
* Versión 17.0.14+6 de OpenJDK (del repositorio de Red Hat Extra Enterprise Linux Server)
* Python 3.13.3 (del repositorio de Red Hat Extra Enterprise Linux Server)
* Versión 7zip 7z2301-linux-x64. Para obtener más información, consulte link:task_configure_7zip_package.html["Configurar el paquete de software 7-zip"].
