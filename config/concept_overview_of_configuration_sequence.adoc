...
image::../media/post_install_flow.png[Un diagrama que muestra el flujo de trabajo de la configuración inicial de Unified Manager y las tareas de configuración administrativa]
